...
평가용 데이터는 [데이콘 경진대회 홈페이지]()에서 받았지만, 대회 규칙상 공식적인 참여자가 아닌 경우 다운로드가 제한될 가능성이 있습니다.
...
* 일부 기사에서는, 다음과 같은 광고 문구들이 기사 마지막에 추가되어 있는 경우가 일부 존재합니다. 
...
(venv) $ python summarize.py \
    --test ./data/test.tsv \
    --model_fpath ./ckpt/{SOME_DATETIME}/hft.gogamza.kobart-base-v1.bs-16*2*8.lr-5e-5.wd-1e-2.warmup-2.adamw.pth \
    --gpu_id 0 \
    --length_penalty 0.8 \
    --batch_size 64
```
...
|Name|Submit Date|Cleaning|Bst./Ep. (\*)|Run T. (H)|Tr-loss|Vl-loss|LP|Min/Max|ROUGE-1|ROUGE-2|ROUGE-N|Note|
|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
...
|20211206<br>-164445|2021-12-06|X|7/10 (7)|10.7|1.0466|1.2471|0.8|64/256|**0.3678**|0.1803|**0.2800**|<span style="color:firebrick">**final submission**</span>|
|20211206<br>-185244|2021-12-07|O|5/10 (5)|10.7|1.1843|1.3380|0.8|64/256|0.3640|**0.1830**|0.2711||
|20211206<br>-164445|2021-12-07|X|7/10 (7)|10.7|1.0466|1.2471|0.8|64≥/≤256|0.3575|0.1760|0.2589|variable summary|
|20211207<br>-192805|2021-12-08|X|5/10 (5)|7.9|1.1085|1.2265|0.8|128/512|0.2846|0.1442|0.2048|variable padding|
|20211207<br>-192805|2021-12-08|X|5/10 (5)|7.9|1.1085|1.2265|0.8|64/256|0.3662|0.1811|0.2731|variable padding|
|20211207<br>-164445|2021-12-08|X|7/10 (10)|10.7|0.9803|1.2599|0.8|64/256|0.3446|0.1689|0.2522||
|20211208<br>-144747|2021-12-09|X|12/26 (12)|20.6|0.9803|1.2599|0.8|64/256|0.3613|0.1771|0.2688|Stop at 26/50|
|20211209<br>-125836|2021-12-09|△|0/10 (0)||||0.8|64/256|||||
...
* Variable Padding: 입력 데이터의 패딩을 고정된 값(e.g. 1024)이 아닌, 배치 단위의 최대 길이로 적용


대회 기간동안 수행된 모든 실험의 로그는 [TensorBoard.dev]()에 Commit하였으며, Fine-tuning된 모델의 가중치 파일들은 별도로 공유하지 않습니다.
